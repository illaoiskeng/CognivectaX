...
for col, (label, ret) in zip(ret_cols, returns_data):
    with col:
        ...
        st.markdown(f"""
        <a href="?period={label}" style="text-decoration: none;">
            <div style="
                background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);
                padding: 15px 10px;
                border-radius: 8px;
            ...
            " onmouseover="this.style.backgroundColor='#f0f7ff'; this.style.border='2px solid #1f77b4';" onmouseout="this.style.backgroundColor=''; this.style.border='2px solid #e0e0e0';">
